...
const elementsHTMlIphone = [
    {
        ...
        textFooter: 'la organización es el principio de la planeación y el nacimiento de la creacion',
...
elementsHTMlIphone.forEach((elIphone) => {
    ...
    footerMenu.append(aShareLinkHome, aShareLinkAbout, aShareLinkProjects, aShareLinkContact);
